          ...
          //      .Field("BYO.Crust", isBYO)
            //    .Field("BYO.Sauce", isBYO)
              ...
              //  .Field(nameof(PizzaOrder.Stuffed), isStuffed)
                .AddRemainingFields()
                //.Confirm("Would you like a  {BYO.Crust} crust, {BYO.Sauce}, {BYO.Toppings} pizza?", isBYO)
                //.Confirm("Would you like a  {&Signature} {Signature} pizza?", isSignature, dependencies: new string[] { "Size", "Kind", "Signature" })
                //.Confirm("Would you like a  {&GourmetDelite} {GourmetDelite} pizza?", isGourmet)
                //.Confirm("Would you like a  {&Stuffed} {Stuffed} pizza?", isStuffed)
                .Build()
                ;
        }
